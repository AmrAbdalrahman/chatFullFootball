module.exports = function (Users, async) {
    ...
    return {
        ...
        groupPostPage: function (req, res) {
            ...
            async.parallel([
                //this function is updated for the receiver of the friend request when its accepted
                function (callback) {
                ...
                //this function is updated for the sender of the friend request when its accepted
                //by the receiver
                function (callback) {
                    if (req.body.senderId) {
                        Users.updateOne({
